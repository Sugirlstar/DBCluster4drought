...
def dbscan(
    ...
    *,
    ...
    spi_condition : array-like of shape (n_samples,), optional, default=None
        An array indicating a condition for each sample. If provided, samples that satisfy the condition will be excluded
        from the neighborhood calculation.
...
class DBSCAN(ClusterMixin, BaseEstimator):
    ...
    def __init__(
        ...
        *,
        ...
        self.p = p
        self.n_jobs = n_jobs
        self.spi_condition = spi_condition
    ...
    def fit(self, X, y=None, sample_weight=None):
        ...
        core_samples = np.asarray((n_neighbors >= self.min_samples) & (self.spi_condition), dtype=np.uint8)
